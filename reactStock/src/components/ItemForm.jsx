...
//criou um modelo de default item para usar
//funçao handleChange pega o estado atual do item ,[ev.target.name] para pegar o atributo dinamicamente que foi alterado pelo nome do input e seta o valor que foi alterado ,salvando os dados
